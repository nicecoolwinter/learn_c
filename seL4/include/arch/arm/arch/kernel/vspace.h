...
exception_t decodeARMMMUInvocation(word_t label, unsigned int length,
                                   cptr_t cptr,
...
exception_t performPageInvocationRemapPTE(asid_t asid, pte_t pte,
        pte_range_t pte_entries);
exception_t performPageInvocationRemapPDE(asid_t asid, pde_t pde,
