...
_MRTIMP2_NCEEPURE float __CLRCALL_PURE_OR_CDECL _Stof(const char*,
        __deref_opt_out_opt char**, long);
_MRTIMP2_NCEEPURE double __CLRCALL_PURE_OR_CDECL _Stod(const char*,
        __deref_opt_out_opt char**, long);
_MRTIMP2_NCEEPURE long double __CLRCALL_PURE_OR_CDECL _Stold(const char*,
        __deref_opt_out_opt char**,
        long);
...
_MRTIMP2 int __cdecl _Wcrtomb(__out char*, wchar_t, mbstate_t*,
                              const _Cvtvec*);
_MRTIMP2_NCEEPURE int __CLRCALL_PURE_OR_CDECL _Wcscoll(const wchar_t*,
        const wchar_t*,
...
_MRTIMP2_NCEEPURE short __CLRCALL_PURE_OR_CDECL _Getwctype(wchar_t,
        const _Ctypevec*);
_MRTIMP2_NCEEPURE const wchar_t* __CLRCALL_PURE_OR_CDECL _Getwctypes(
    const wchar_t*, const wchar_t*,
    short*, const _Ctypevec*);
_MRTIMP2_NCEEPURE wchar_t __CLRCALL_PURE_OR_CDECL _Towlower(wchar_t,
        const _Ctypevec*);
_MRTIMP2_NCEEPURE wchar_t __CLRCALL_PURE_OR_CDECL _Towupper(wchar_t,
        const _Ctypevec*);
#ifndef MRTDLL
#ifndef _M_CEE_PURE
_END_C_LIB_DECL
