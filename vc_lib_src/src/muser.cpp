...
volatile __declspec(appdomain) _invalid_parameter_handler_m __pParameter_m =
    (_invalid_parameter_handler_m) _encoded_null();
...
)
{
    ...
    _invalid_parameter_handler_m function = (_invalid_parameter_handler_m)
                                            _decode_pointer(__pParameter_m);
...
_set_invalid_parameter_handler(_invalid_parameter_handler_m pNew)
{
    ...
    _invalid_parameter_handler_m pOld = (_invalid_parameter_handler_m)
                                        _decode_pointer(__pParameter_m);
    _set_invalid_parameter_handler(pNew != NULL ?
                                   __invalid_parameter_handler_thunk : static_cast<_invalid_parameter_handler>
                                   (NULL));
...
{
public:
    [System::ThreadStaticAttribute] __declspec(appdomain) static
    __terminate_function_m __pTerminate_m;
    [System::ThreadStaticAttribute] __declspec(appdomain) static
    __unexpected_function_m __pUnexpected_m;
    [System::ThreadStaticAttribute] __declspec(appdomain) static _purecall_handler_m
    __pPurecall_m;
};
__declspec(appdomain) __terminate_function_m Handlers::__pTerminate_m =
    (__terminate_function_m) _encoded_null();
__declspec(appdomain) __unexpected_function_m Handlers::__pUnexpected_m =
    (__unexpected_function_m) _encoded_null();
__declspec(appdomain) _purecall_handler_m Handlers::__pPurecall_m =
    (_purecall_handler_m) _encoded_null();
}
...
{
    __terminate_function_m function = (__terminate_function_m) _decode_pointer(
...
{
    _purecall_handler_m handler = (_purecall_handler_m) _decode_pointer(
                                      Handlers::__pPurecall_m);
...
#pragma warning(pop)
#endif  /* defined (_DEBUG) */
    {
        ...
        _set_purecall_handler(pNew == NULL ? (_purecall_handler)NULL :
                              __purecall_thunk);
    }
...
{
    __unexpected_function_m function = (__unexpected_function_m) _decode_pointer(
                                           Handlers::__pUnexpected_m);
...
_set_invalid_parameter_handler(int pNew)
{
    ...
    return _set_invalid_parameter_handler(static_cast<_invalid_parameter_handler>
                                          (0));
}
