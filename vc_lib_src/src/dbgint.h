...
_CRTIMP __checkReturn __bcount_opt(_Size) void* __cdecl _malloc_crt(
    __in size_t _Size);
_CRTIMP __checkReturn __bcount_opt(_Size* _Count) void* __cdecl _calloc_crt(
    __in size_t _Count, __in size_t _Size);
_CRTIMP __checkReturn __bcount_opt(_Size) void* __cdecl _realloc_crt(
    __inout_opt void* _Ptr, __in size_t _Size);
_CRTIMP __checkReturn __bcount_opt(_Size* _Count) void* __cdecl _recalloc_crt(
    __inout_opt void* _Ptr, __in size_t _Count, __in size_t _Size);
