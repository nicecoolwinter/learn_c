...
_MRTIMP2 locale::_Locimp* __cdecl locale::_Locimp::_Makeloc(
    const _Locinfo& lobj,
...
_MRTIMP2 void __cdecl locale::_Locimp::_Locimp_ctor(locale::_Locimp* _This,
        const locale::_Locimp& imp)
{
...
_MRTIMP2 void __cdecl locale::_Locimp::_Locimp_Addfac(_Locimp* _This,
        locale::facet* ptrfac, size_t id)
{
...
_MRTIMP2_NPURE void __cdecl _Locinfo::_Locinfo_ctor(_Locinfo* pLocinfo, int cat,
        const char* locname)
{
...
_MRTIMP2_NPURE _Locinfo& __cdecl _Locinfo::_Locinfo_Addcats(_Locinfo* pLocinfo,
        int cat, const char* locname)
{
