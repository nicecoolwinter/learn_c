...
_CRTIMP __checkReturn int __cdecl _tolower_l(__in int _C,
        __in_opt _locale_t _Locale);
_CRT_JIT_INTRINSIC _CRTIMP __checkReturn int __cdecl _toupper(__in int _C);
_CRTIMP __checkReturn int __cdecl _toupper_l(__in int _C,
        __in_opt _locale_t _Locale);
...
#ifndef _CTYPE_DEFINED
_CRT_NONSTDC_DEPRECATE(__isascii) _CRTIMP __checkReturn int __cdecl isascii(
    __in int _C);
_CRT_NONSTDC_DEPRECATE(__toascii) _CRTIMP __checkReturn int __cdecl toascii(
    __in int _C);
_CRT_NONSTDC_DEPRECATE(__iscsymf) _CRTIMP __checkReturn int __cdecl iscsymf(
    __in int _C);
_CRT_NONSTDC_DEPRECATE(__iscsym) _CRTIMP __checkReturn int __cdecl iscsym(
    __in int _C);
#else  /* _CTYPE_DEFINED */
