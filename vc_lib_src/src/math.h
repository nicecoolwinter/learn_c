...
_CRT_NONSTDC_DEPRECATE(_cabs) _CRTIMP double  __cdecl cabs(
    __in struct _complex _X);
_CRT_NONSTDC_DEPRECATE(_hypot) _CRTIMP double  __cdecl hypot(__in double _X,
        __in double _Y);
...
_CRT_NONSTDC_DEPRECATE(_jn) _CRTIMP double  __cdecl jn(__in int _X,
        __in double _Y);
...
_CRT_NONSTDC_DEPRECATE(_yn) _CRTIMP double  __cdecl yn(__in int _X,
        __in double _Y);
