...
_CRT_MANAGED_FP_DEPRECATE _CRT_INSECURE_DEPRECATE(_controlfp_s) _CRTIMP unsigned
int __cdecl _controlfp(__in unsigned int _NewValue, __in unsigned int _Mask);
#pragma warning(pop)
_CRT_MANAGED_FP_DEPRECATE _CRTIMP void __cdecl _set_controlfp(
    __in unsigned int _NewValue, __in unsigned int _Mask);
_CRT_MANAGED_FP_DEPRECATE _CRTIMP errno_t __cdecl _controlfp_s(
    __out_opt unsigned int* _CurrentState, __in unsigned int _NewValue,
...
#if defined (_M_IX86)
_CRT_MANAGED_FP_DEPRECATE _CRTIMP void __cdecl _statusfp2(
    __out_opt unsigned int* _X86_status, __out_opt unsigned int* _SSE2_status);
...
_CRT_MANAGED_FP_DEPRECATE _CRTIMP unsigned int __cdecl _control87(
    __in unsigned int _NewValue, __in unsigned int _Mask);
#if defined (_M_IX86)
_CRT_MANAGED_FP_DEPRECATE _CRTIMP int __cdecl __control87_2(
    __in unsigned int _NewValue, __in unsigned int _Mask,
...
_CRTIMP __checkReturn double __cdecl _copysign(__in double _Number,
        __in double _Sign);
