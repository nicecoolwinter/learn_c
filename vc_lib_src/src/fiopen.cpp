...
_MRTIMP2_NCEEPURE FILE* __CLRCALL_PURE_OR_CDECL _Xfsopen(
    __in_z const wchar_t* filename, __in_z const wchar_t* mode, __in int prot)
{
...
_MRTIMP2_NCEEPURE FILE* __CLRCALL_PURE_OR_CDECL _Fiopen(
    const _Sysch_t* filename,
    ios_base::openmode mode, int prot)
{
...
_MRTIMP2_NCEEPURE _Filet* __CLRCALL_PURE_OR_CDECL _Fiopen(
    const unsigned short* _Filename,
