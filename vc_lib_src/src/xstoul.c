...
extern "C"
#endif
_MRTIMP2_NCEEPURE unsigned long __CLRCALL_PURE_OR_CDECL _Stoulx(const char* s,
        char** endptr,
        int base, int* perr)
{
...
_MRTIMP2_NCEEPURE unsigned long __CLRCALL_PURE_OR_CDECL _Stoul(const char* s,
