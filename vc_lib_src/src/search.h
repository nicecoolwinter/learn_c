...
_CRTIMP __checkReturn void* __cdecl _lfind_s(__in const void* _Key,
        __in_bcount((*_NumOfElements) * _SizeOfElements) const void* _Base,
        __inout unsigned int* _NumOfElements, __in size_t _SizeOfElements,
        __in int (__cdecl* _PtFuncCompare)(void*, const void*, const void*),
        void* _Context);
_CRTIMP __checkReturn void* __cdecl _lfind(__in const void* _Key,
        __in_bcount((*_NumOfElements) * _SizeOfElements) const void* _Base,
        __inout unsigned int* _NumOfElements, __in unsigned int _SizeOfElements,
        __in int (__cdecl* _PtFuncCompare)(const void*, const void*));

_CRTIMP __checkReturn void* __cdecl _lsearch_s(__in const void* _Key,
        __inout_bcount((*_NumOfElements) * _SizeOfElements) void*   _Base,
        __inout unsigned int* _NumOfElements, __in size_t _SizeOfElements,
        __in int (__cdecl* _PtFuncCompare)(void*, const void*, const void*),
        void* _Context);
_CRTIMP __checkReturn void* __cdecl _lsearch(__in const void* _Key,
        __inout_bcount((*_NumOfElements) * _SizeOfElements) void*   _Base,
        __inout unsigned int* _NumOfElements, __in unsigned int _SizeOfElements,
        __in int (__cdecl* _PtFuncCompare)(const void*, const void*));
...
_CRTIMP _CRT_NONSTDC_DEPRECATE(_lfind) __checkReturn void* __cdecl lfind(
    __in const void* _Key, __in_bcount((*_NumOfElements) * _SizeOfElements) const
    void* _Base,
    __inout unsigned int* _NumOfElements, __in unsigned int _SizeOfElements,
    __in int (__cdecl* _PtFuncCompare)(const void*, const void*));
_CRTIMP _CRT_NONSTDC_DEPRECATE(_lsearch) __checkReturn void* __cdecl lsearch(
    __in const void* _Key, __inout_bcount((*_NumOfElements) * _SizeOfElements) void*
    _Base,
    __inout unsigned int* _NumOfElements, __in unsigned int _SizeOfElements,
    __in int (__cdecl* _PtFuncCompare)(const void*, const void*));
