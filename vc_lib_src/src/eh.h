...
_CRTIMP int __cdecl _is_exception_typeof(__in const type_info& _Type,
        __in struct _EXCEPTION_POINTERS* _ExceptionPtr);

#ifndef _M_CEE_PURE
/* only __clrcall versions provided by the MRT exist in pure */
_CRTIMP terminate_function __cdecl set_terminate(__in_opt terminate_function
        _NewPtFunc);
extern "C" _CRTIMP terminate_function __cdecl _get_terminate(void);
_CRTIMP unexpected_function __cdecl set_unexpected(__in_opt unexpected_function
        _NewPtFunc);
...
_CRTIMP _se_translator_function __cdecl _set_se_translator(
    __in_opt _se_translator_function _NewPtFunc);
#endif  /* _M_CEE_PURE */
...
#ifdef _M_CEE
_MRTIMP __terminate_function_m __cdecl set_terminate(__in_opt
        __terminate_function_m _NewPtFunc);
_MRTIMP __unexpected_function_m __cdecl set_unexpected(__in_opt
        __unexpected_function_m _NewPtFunc);
#endif  /* _M_CEE */
 ...
 */
typedef terminate_function(__cdecl* _set_terminate_function)(
    terminate_function);
typedef terminate_function(__cdecl* _get_terminate_function)(void);
typedef unexpected_function(__cdecl* _set_unexpected_function)(
    unexpected_function);
