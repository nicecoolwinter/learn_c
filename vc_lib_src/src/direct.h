...
_CRTIMP __checkReturn __out_z_opt char* __cdecl _getcwd(__out_ecount_opt(
            _SizeInBytes) char* _DstBuf, __in int _SizeInBytes);
_CRTIMP __checkReturn __out_z_opt char* __cdecl _getdcwd(__in int _Drive,
        __out_ecount_opt(_SizeInBytes) char* _DstBuf, __in int _SizeInBytes);
__checkReturn __out_z_opt char* __cdecl _getdcwd_nolock(__in int _Drive,
        __out_ecount_opt(_SizeInBytes) char* _DstBuf, __in int _SizeInBytes);
...
_CRTIMP __checkReturn unsigned __cdecl _getdiskfree(__in unsigned _Drive,
        __out struct _diskfree_t* _DiskFree);
...
_CRT_NONSTDC_DEPRECATE(_getcwd) _CRTIMP __checkReturn __out_z_opt char* __cdecl
getcwd(__out_ecount_opt(_SizeInBytes) char* _DstBuf, __in int _SizeInBytes);

#if defined (_DEBUG) && defined (_CRTDBG_MAP_ALLOC)
#pragma pop_macro("getcwd")
#endif  /* defined (_DEBUG) && defined (_CRTDBG_MAP_ALLOC) */

_CRT_NONSTDC_DEPRECATE(_chdir) _CRTIMP __checkReturn int __cdecl chdir(
    __in_z const char* _Path);
_CRT_NONSTDC_DEPRECATE(_mkdir) _CRTIMP __checkReturn int __cdecl mkdir(
    __in_z const char* _Path);
_CRT_NONSTDC_DEPRECATE(_rmdir) _CRTIMP __checkReturn int __cdecl rmdir(
    __in_z const char* _Path);
