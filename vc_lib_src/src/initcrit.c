...
)
{
    ...
    PFN_INIT_CRITSEC_AND_SPIN_COUNT pfnInitCritSecAndSpinCount =
        (PFN_INIT_CRITSEC_AND_SPIN_COUNT) _decode_pointer(__pfnInitCritSecAndSpinCount);
    ...
    if (pfnInitCritSecAndSpinCount == NULL) {
        ...
        __pfnInitCritSecAndSpinCount = (PFN_INIT_CRITSEC_AND_SPIN_COUNT)
                                       _encode_pointer(pfnInitCritSecAndSpinCount);
    }
    ...
    } __except (_exception_code() == STATUS_NO_MEMORY ? EXCEPTION_EXECUTE_HANDLER :
