...
_CRT_INSECURE_DEPRECATE(_ftime32_s) _CRTIMP void __cdecl _ftime32(
    __out struct __timeb32* _Time);
_CRTIMP errno_t __cdecl _ftime32_s(__out struct __timeb32* _Time);
#if _INTEGRAL_MAX_BITS >= 64
_CRT_INSECURE_DEPRECATE(_ftime64_s) _CRTIMP void __cdecl _ftime64(
    __out struct __timeb64* _Time);
