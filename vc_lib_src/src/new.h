...
#endif  /* _M_CEE */
_CRTIMP2 new_handler __cdecl set_new_handler(__in_opt new_handler _NewHandler)
throw();
#ifdef _M_CEE_MIXED
extern "C++" _MRTIMP _new_handler_m __cdecl set_new_handler(
    __in_opt _new_handler_m _NewHandler) throw();
...
extern "C++" _MRTIMP __MPNH __cdecl _set_new_handler(__in_opt __MPNH
        _NewHandler);
#endif  /* _M_CEE_MIXED */
