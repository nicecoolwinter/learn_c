...
__checkReturn  __bcount_opt(_Size) void* __cdecl _nh_malloc(__in size_t _Size,
        __in int _NhFlag);
...
extern _CRTIMP __checkReturn __bcount_opt(_Size) void*   __cdecl _malloc_base(
    __in size_t _Size);

extern _CRTIMP void    __cdecl _free_base(__inout_opt void* _Memory);
extern __checkReturn __bcount_opt(_NewSize) void*   __cdecl _realloc_base(
    __inout_opt void* _Memory, __in size_t _NewSize);
extern __checkReturn __bcount_opt(_Size* _Count) void*   __cdecl _recalloc_base(
    __inout_opt void* _Memory, __in size_t _Count, __in size_t _Size);

extern __checkReturn __bcount_opt(_NewSize) void*   __cdecl _expand_base(
    __inout_opt void* _Memory, __in size_t _NewSize);
extern __checkReturn __bcount_opt(_Count* _Size) void*   __cdecl _calloc_base(
    __in size_t _Count, __in size_t _Size);
...
extern __checkReturn __bcount_opt(_Size) void*   __cdecl __sbh_alloc_block(
    __in int _Size);
extern __checkReturn __out_opt PHEADER __cdecl __sbh_alloc_new_region(void);
extern __checkReturn int     __cdecl __sbh_alloc_new_group(
    __in PHEADER _Header);

extern __checkReturn PHEADER __cdecl __sbh_find_block(__in void* _Block);

#ifdef _DEBUG
extern __checkReturn int     __cdecl __sbh_verify_block(__in PHEADER _Header,
        __in void* _Block);
#endif  /* _DEBUG */

extern void    __cdecl __sbh_free_block(__in PHEADER _Header,
                                        __inout void* _Block);
extern __checkReturn int     __cdecl __sbh_resize_block(__in PHEADER _Header,
        __inout void* _Block, __in int _Size);
...
__checkReturn __old_page_map_t* __cdecl __old_sbh_find_block(__in void* _Block,
        __out __old_sbh_region_t** _Region,
        __out __old_sbh_page_t** _Page);
void      __cdecl __old_sbh_free_block(__in __old_sbh_region_t* _Region,
                                       __in __old_sbh_page_t* _Page,
