...
)
{
    ...
    case ('a'): {           /* abbreviated weekday name */
            _VALIDATE_RETURN(((timeptr->tm_wday >= 0) &&
                              (timeptr->tm_wday <= 6)), EINVAL, FALSE)
    ...
    case ('b'): {           /* abbreviated month name */
            _VALIDATE_RETURN(((timeptr->tm_mon >= 0) &&
                              (timeptr->tm_mon <= 11)), EINVAL, FALSE)
    ...
    case ('d'):             /* mday in decimal (01-31) */
        ...
        {
            _VALIDATE_RETURN(((timeptr->tm_mday >= 1) &&
                              (timeptr->tm_mday <= 31)), EINVAL, FALSE)
    ...
    case ('H'):             /* 24-hour decimal (00-23) */
        /* pass alternate_form as the no leading zeros flag */
        {
            _VALIDATE_RETURN(((timeptr->tm_hour >= 0) &&
                              (timeptr->tm_hour <= 23)), EINVAL, FALSE)
    ...
    case ('j'):             /* yday in decimal (001-366) */
        /* pass alternate_form as the no leading zeros flag */
        {
            _VALIDATE_RETURN(((timeptr->tm_yday >= 0) &&
                              (timeptr->tm_yday <= 365)), EINVAL, FALSE)
    ...
    case ('M'):             /* minute in decimal (00-59) */
        /* pass alternate_form as the no leading zeros flag */
        {
            _VALIDATE_RETURN(((timeptr->tm_min >= 0) &&
                              (timeptr->tm_min <= 59)), EINVAL, FALSE)
    ...
    case ('S'):             /* secs in decimal (00-59) */
        /* pass alternate_form as the no leading zeros flag */
        {
            _VALIDATE_RETURN(((timeptr->tm_sec >= 0) &&
                              (timeptr->tm_sec <= 59)), EINVAL, FALSE)
