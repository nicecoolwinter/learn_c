...
template _MRTIMP2 basic_istream<char, char_traits<char> >& __CLRCALL_OR_CDECL
operator>>(
...
operator>>(
    basic_istream<char, char_traits<char> >&, unsigned char&);
template _MRTIMP2 basic_istream<wchar_t, char_traits<wchar_t> >&
...
template _MRTIMP2 basic_istream<unsigned short, char_traits<unsigned short> >&
__CLRCALL_OR_CDECL operator>>(
...
template _MRTIMP2 basic_ostream<char, char_traits<char> >& __CLRCALL_OR_CDECL
operator<<(
...
template _MRTIMP2 basic_ostream<wchar_t, char_traits<wchar_t> >&
__CLRCALL_OR_CDECL operator<<(
...
#ifdef _NATIVE_WCHAR_T_DEFINED
template _MRTIMP2 basic_ostream<unsigned short, char_traits<unsigned short> >&
__CLRCALL_OR_CDECL operator<<(
...
template _MRTIMP2 basic_string<char, char_traits<char>, allocator<char> >
__CLRCALL_OR_CDECL operator+(
...
template _MRTIMP2 complex<float> __CLRCALL_OR_CDECL operator+
(const complex<float>&, const complex<float>&);
template _MRTIMP2 complex<float> __CLRCALL_OR_CDECL operator+
(const complex<float>&, const float&);
template _MRTIMP2 complex<float> __CLRCALL_OR_CDECL operator+(const float&,
        const complex<float>&);
template _MRTIMP2 complex<float> __CLRCALL_OR_CDECL operator-
(const complex<float>&, const complex<float>&);
template _MRTIMP2 complex<float> __CLRCALL_OR_CDECL operator-
...
template _MRTIMP2 complex<float> __CLRCALL_OR_CDECL operator-
(const complex<float>&);
template _MRTIMP2 bool __CLRCALL_OR_CDECL operator==(const complex<float>&,
        const complex<float>&);
template _MRTIMP2 bool __CLRCALL_OR_CDECL operator==(const complex<float>&,
        const float&);
template _MRTIMP2 bool __CLRCALL_OR_CDECL operator==(const float&,
        const complex<float>&);
template _MRTIMP2 bool __CLRCALL_OR_CDECL operator!=(const complex<float>&,
        const complex<float>&);
template _MRTIMP2 bool __CLRCALL_OR_CDECL operator!=(const complex<float>&,
...
template _MRTIMP2 complex<float> __CLRCALL_OR_CDECL log10(
    const complex<float>&);
...
template _MRTIMP2 complex<float> __CLRCALL_OR_CDECL polar(const float&,
        const float&);
template _MRTIMP2 complex<float> __CLRCALL_OR_CDECL polar(const float&);
template _MRTIMP2 complex<float> __CLRCALL_OR_CDECL pow(const complex<float>&,
        const complex<float>&);
template _MRTIMP2 complex<float> __CLRCALL_OR_CDECL pow(const complex<float>&,
        const float&);
template _MRTIMP2 complex<float> __CLRCALL_OR_CDECL pow(const complex<float>&,
        int);
template _MRTIMP2 complex<float> __CLRCALL_OR_CDECL pow(const float&,
        const complex<float>&);
...
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL operator+
(const complex<double>&, const complex<double>&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL operator+
(const complex<double>&, const double&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL operator+(const double&,
        const complex<double>&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL operator-
(const complex<double>&, const complex<double>&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL operator-
...
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL operator-
(const complex<double>&);
template _MRTIMP2 bool __CLRCALL_OR_CDECL operator==(const complex<double>&,
        const complex<double>&);
template _MRTIMP2 bool __CLRCALL_OR_CDECL operator==(const complex<double>&,
        const double&);
template _MRTIMP2 bool __CLRCALL_OR_CDECL operator==(const double&,
        const complex<double>&);
template _MRTIMP2 bool __CLRCALL_OR_CDECL operator!=(const complex<double>&,
        const complex<double>&);
template _MRTIMP2 bool __CLRCALL_OR_CDECL operator!=(const complex<double>&,
...
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL conj(
    const complex<double>&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL cos(
    const complex<double>&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL cosh(
    const complex<double>&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL exp(
    const complex<double>&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL log(
    const complex<double>&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL log10(
    const complex<double>&);
...
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL polar(const double&,
        const double&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL polar(const double&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL pow(const complex<double>&,
        const complex<double>&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL pow(const complex<double>&,
        const double&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL pow(const complex<double>&,
        int);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL pow(const double&,
        const complex<double>&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL sin(
    const complex<double>&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL sinh(
    const complex<double>&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL sqrt(
    const complex<double>&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL tanh(
    const complex<double>&);
template _MRTIMP2 complex<double> __CLRCALL_OR_CDECL tan(
    const complex<double>&);

template _MRTIMP2 long double __CLRCALL_OR_CDECL imag(const
        complex<long double>&);
template _MRTIMP2 long double __CLRCALL_OR_CDECL real(const
        complex<long double>&);
template _MRTIMP2 long double __CLRCALL_OR_CDECL _Fabs(const
        complex<long double>&, int*);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL operator+
...
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL operator-
(const complex<long double>&);
template _MRTIMP2 bool __CLRCALL_OR_CDECL operator==(const
        complex<long double>&, const complex<long double>&);
template _MRTIMP2 bool __CLRCALL_OR_CDECL operator==(const
        complex<long double>&, const long double&);
template _MRTIMP2 bool __CLRCALL_OR_CDECL operator==(const long double&,
        const complex<long double>&);
template _MRTIMP2 bool __CLRCALL_OR_CDECL operator!=(const
        complex<long double>&, const complex<long double>&);
template _MRTIMP2 bool __CLRCALL_OR_CDECL operator!=(const
...
template _MRTIMP2 bool __CLRCALL_OR_CDECL operator!=(const long double&,
        const complex<long double>&);
template _MRTIMP2 long double __CLRCALL_OR_CDECL abs(const
        complex<long double>&);
template _MRTIMP2 long double __CLRCALL_OR_CDECL arg(const
        complex<long double>&);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL conj(
    const complex<long double>&);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL cos(
    const complex<long double>&);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL cosh(
    const complex<long double>&);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL exp(
    const complex<long double>&);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL log(
    const complex<long double>&);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL log10(
    const complex<long double>&);
template _MRTIMP2 long double __CLRCALL_OR_CDECL norm(const
        complex<long double>&);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL polar(
    const long double&, const long double&);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL polar(
    const long double&);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL pow(
    const complex<long double>&, const complex<long double>&);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL pow(
    const complex<long double>&, const long double&);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL pow(
...
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL pow(
    const long double&, const complex<long double>&);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL sin(
    const complex<long double>&);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL sinh(
    const complex<long double>&);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL sqrt(
    const complex<long double>&);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL tanh(
    const complex<long double>&);
template _MRTIMP2 complex<long double> __CLRCALL_OR_CDECL tan(
    const complex<long double>&);
