...
_PGLOBAL _CRTDATA2 const streamoff _BADOFF =
    -1;    // initialize constant for bad file offset
...
__PURE_APPDOMAIN_GLOBAL int ios_base::_Index =
    0;   // initialize source of unique indexes
__PURE_APPDOMAIN_GLOBAL bool ios_base::_Sync =
    true;    // initialize synchronization flag
