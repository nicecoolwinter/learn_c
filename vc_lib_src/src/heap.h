...
__checkReturn  __bcount_opt(_Size) void* __cdecl _flat_malloc(
    __in size_t _Size);
__checkReturn _PBLKDESC __getempty(void);
void __cdecl _heap_abort(void);
__checkReturn int __cdecl _heap_addblock(__in void* _Block,
        __in unsigned int _Size);


void __cdecl _heap_free_region(__in int _Index);
__checkReturn int __cdecl _heap_findaddr(__in void* _Block,
        __out _PBLKDESC* _PDesc);
__checkReturn int __cdecl _heap_grow(__in unsigned int _Size);
__checkReturn int __cdecl _heap_grow_region(__in unsigned _Index,
        __in size_t _Size);
...
__checkReturn _PBLKDESC __cdecl _heap_split_block(__in _PBLKDESC _Pdesc,
...
size_t __cdecl _heapused_nolock(__out_opt size_t* _PUsed,
                                __out_opt size_t* _PFree);
