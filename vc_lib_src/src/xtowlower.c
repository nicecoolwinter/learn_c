...
_C_STD_BEGIN
_MRTIMP2_NCEEPURE wchar_t __CLRCALL_PURE_OR_CDECL _Towlower(wchar_t _Ch,
...
#ifdef MRTDLL
_MRTIMP2_NCEEPURE unsigned short __CLRCALL_PURE_OR_CDECL _Towlower(
    unsigned short _Ch, const _Ctypevec* _Ctype)
{
