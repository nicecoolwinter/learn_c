...
errno_t _cftoe(__in double* _Value, __out_bcount_z(3 + _Dec + 5 + 1) char* _Buf,
               __in size_t _SizeInBytes, __in int _Dec, __in int _Caps);
errno_t _cftoa(__in double* _Value, __out_bcount_z(1 + 4 + _Dec + 6) char* _Buf,
               __in size_t _SizeInBytes, __in int _Dec, __in int _Caps);
errno_t _cftof(__in double* _Value, __out_bcount_z(_SizeInBytes) char* _Buf,
               __in size_t _SizeInBytes, __in int _Dec);
errno_t __cdecl _fptostr(__out_bcount_z(_SizeInBytes) char* _Buf,
                         __in size_t _SizeInBytes, __in int _Digits, __inout STRFLT _PtFlt);
...
_CRTIMP __checkReturn int __cdecl _atoldbl_l(__out _LDOUBLE* _Result,
        __in_z char* _Str, __in_opt _locale_t _Locale);
_CRTIMP __checkReturn int __cdecl _atoflt_l(__out _CRT_FLOAT* _Result,
        __in_z char* _Str, __in_opt _locale_t _Locale);


STRFLT  __cdecl _fltout2(__in _CRT_DOUBLE _Dbl, __out STRFLT _Flt,
                         __out_bcount_z(_SizeInBytes) char* _ResultStr, __in size_t _SizeInBytes);
FLT     __cdecl _fltin2(__out FLT _Flt, __in_z const char* _Str,
                        __in int _LenIgnore, __in int _ScaleIgnore, __in int _RadixIgnore,
                        __in _locale_t _Locale);
FLT     __cdecl _wfltin2(__out FLT _Fit, __in_z const wchar_t* _Str,
                         __in int _LenIgnore, __in int _ScaleIgnore, __in int _RadixIgnore,
                         __in _locale_t _Locale);
