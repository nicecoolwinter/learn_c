...
_MRTIMP2_NCEEPURE long double __CLRCALL_PURE_OR_CDECL _LCosh(long double,
        long double);
_MRTIMP2_NCEEPURE short __CLRCALL_PURE_OR_CDECL _LDtest(long double*);
_MRTIMP2_NCEEPURE short __CLRCALL_PURE_OR_CDECL _LExp(long double*, long double,
        short);
_MRTIMP2_NCEEPURE long double __CLRCALL_PURE_OR_CDECL _LSinh(long double,
        long double);
