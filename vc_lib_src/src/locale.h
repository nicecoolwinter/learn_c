...
_CRTIMP __checkReturn_opt char* __cdecl setlocale(__in int _Category,
        __in_z_opt const char* _Locale);
...
_CRTIMP __checkReturn_opt _locale_t __cdecl _create_locale(__in int _Category,
        __in_z const char* _Locale);
...
_CRT_OBSOLETE(_get_current_locale) _CRTIMP __checkReturn _locale_t __cdecl
__get_current_locale(void);
_CRT_OBSOLETE(_create_locale) _CRTIMP __checkReturn _locale_t __cdecl
__create_locale(__in int _Category, __in_z const char* _Locale);
_CRT_OBSOLETE(_free_locale) _CRTIMP void __cdecl __free_locale(
