...
)
{
    ...
    return (*(double*) & (_wfltin2(&fltstruct, nptr, (int)wcslen(nptr), 0, 0,
                                   _loc_update.GetLocaleT())->dval));
}
...
)
{
    ...
    return __wstrgtold12_l(pld12, p_end_ptr, str, mult12, scale, decpt, implicit_E,
