...
char textmode :
    7;     /* __IOINFO_TM_ANSI or __IOINFO_TM_UTF8 or __IOINFO_TM_UTF16LE */
...
FILE* __cdecl _openfile(__in_z const char* _Filename, __in_z const char* _Mode,
                        __in int _ShFlag, __out FILE* _File);
FILE* __cdecl _wopenfile(__in_z const wchar_t* _Filename,
                         __in_z const wchar_t* _Mode, __in int _ShFlag, __out FILE* _File);
...
int __cdecl _output(__inout FILE* _File,
                    __in_z __format_string const char* _Format, va_list _ArgList);
int __cdecl _woutput(__inout FILE* _File,
                     __in_z __format_string const wchar_t* _Format, va_list _ArgList);
int __cdecl _output_s(__inout FILE* _File,
                      __in_z __format_string const char* _Format, va_list _ArgList);
int __cdecl _output_p(__inout FILE* _File,
                      __in_z __format_string const char* _Format, va_list _ArgList);
int __cdecl _woutput_s(__inout FILE* _File,
                       __in_z __format_string const wchar_t* _Format, va_list _ArgList);
int __cdecl _woutput_p(__inout FILE* _File,
                       __in_z __format_string const wchar_t* _Format, va_list _ArgList);
...
int __cdecl _output_l(__inout FILE* _File,
                      __in_z __format_string const char* _Format, __in_opt _locale_t _Locale,
                      va_list _ArgList);
int __cdecl _woutput_l(__inout FILE* _File,
                       __in_z __format_string const wchar_t* _Format, __in_opt _locale_t _Locale,
                       va_list _ArgList);
int __cdecl _output_s_l(__inout FILE* _File,
                        __in_z __format_string const char* _Format, __in_opt _locale_t _Locale,
                        va_list _ArgList);
int __cdecl _output_p_l(__inout FILE* _File,
                        __in_z __format_string const char* _Format, __in_opt _locale_t _Locale,
                        va_list _ArgList);
int __cdecl _woutput_s_l(__inout FILE* _File,
                         __in_z __format_string const wchar_t* _Format, __in_opt _locale_t _Locale,
                         va_list _ArgList);
int __cdecl _woutput_p_l(__inout FILE* _File,
                         __in_z __format_string const wchar_t* _Format, __in_opt _locale_t _Locale,
                         va_list _ArgList);
typedef int (*OUTPUTFN)(__inout FILE* _File, const char*, _locale_t, va_list);
typedef int (*WOUTPUTFN)(__inout FILE* _File, const wchar_t*, _locale_t,
                         va_list);
...
int __cdecl _input(__in FILE* _File,
                   __in_z __format_string const unsigned char* _Format, va_list _ArgList);
int __cdecl _winput(__in FILE* _File,
                    __in_z __format_string const wchar_t* _Format, va_list _ArgList);
int __cdecl _input_s(__in FILE* _File,
                     __in_z __format_string const unsigned char* _Format, va_list _ArgList);
int __cdecl _winput_s(__in FILE* _File,
                      __in_z __format_string const wchar_t* _Format, va_list _ArgList);
...
int __cdecl _input_l(__inout FILE* _File,
                     __in_z __format_string const unsigned char*, __in_opt _locale_t _Locale,
                     va_list _ArgList);
int __cdecl _winput_l(__inout FILE* _File,
                      __in_z __format_string const wchar_t*, __in_opt _locale_t _Locale,
                      va_list _ArgList);
int __cdecl _input_s_l(__inout FILE* _File,
                       __in_z __format_string const unsigned char*, __in_opt _locale_t _Locale,
                       va_list _ArgList);
int __cdecl _winput_s_l(__inout FILE* _File,
                        __in_z __format_string const wchar_t*, __in_opt _locale_t _Locale,
                        va_list _ArgList);
...
char* __cdecl _getpath(__in_z const char* _Src,
                       __out_ecount_z(_SizeInChars) char* _Dst, __in size_t _SizeInChars);
wchar_t* __cdecl _wgetpath(__in_z const wchar_t* _Src,
                           __out_ecount_z(_SizeInWords) wchar_t* _Dst, __in size_t _SizeInWords);
...
int __CRTDECL main(__in int _Argc, __in_ecount_z(_Argc) char** _Argv,
                   __in_z char** _Env);
int __CRTDECL wmain(__in int _Argc, __in_ecount_z(_Argc) wchar_t** _Argv,
                    __in_z wchar_t** _Env);
#endif  /* _MANAGED_MAIN */
...
/* These two functions take a char ** for the environment option
   ...
   double-free
*/
int __cdecl __crtsetenv(__deref_inout_opt char** _POption,
                        __in const int _Primary);
int __cdecl __crtwsetenv(__deref_inout_opt wchar_t** _POption,
                         __in const int _Primary);
...
_CRTIMP int __cdecl __wgetmainargs(__out int* _Argc,
                                   __deref_out_ecount(*_Argc)wchar_t** * _Argv,
...
extern intptr_t __cdecl _dospawn(__in int _Mode, __in_z_opt const char* _Name,
                                 __inout_z char* _Cmd, __in_z_opt char* _Env);
extern intptr_t __cdecl _wdospawn(__in int _Mode,
                                  __in_z_opt const wchar_t* _Name, __inout_z wchar_t* _Cmd,
                                  __in_z_opt wchar_t* _Env);
extern int __cdecl _cenvarg(__in_z const char* const* _Argv,
                            __in_z_opt const char* const* _Env,
                            __deref_out_opt char** _ArgBlk, __deref_out_opt char** _EnvBlk,
                            __in_z const char* _Name);
extern int __cdecl _wcenvarg(__in_z const wchar_t* const* _Argv,
                             __in_z_opt const wchar_t* const* _Env,
                             __deref_out_opt wchar_t** _ArgBlk, __deref_out_opt wchar_t** _EnvBlk,
                             __in_z const wchar_t* _Name);
#ifndef _M_IX86
extern char** _capture_argv(__in va_list*, __in_z const char* _FirstArg,
                            __out_ecount_z(_MaxCount) char** _Static_argv, __in size_t _MaxCount);
extern wchar_t** _wcapture_argv(__in va_list*, __in_z const wchar_t* _FirstArg,
                                __out_ecount_z(_MaxCount) wchar_t** _Static_argv, __in size_t _MaxCount);
#endif  /* _M_IX86 */
...
_CRTIMP
#endif  /* _SAFECRT_IMPL */
void __cdecl _invalid_parameter(__in_z_opt const wchar_t*,
                                __in_z_opt const wchar_t*, __in_z_opt const wchar_t*, unsigned int, uintptr_t);

#if !defined (_NATIVE_WCHAR_T_DEFINED) && defined (_M_CEE_PURE)
extern "C++"
#endif  /* !defined (_NATIVE_WCHAR_T_DEFINED) && defined (_M_CEE_PURE) */
_CRTIMP
void __cdecl _invoke_watson(__in_z_opt const wchar_t*,
                            __in_z_opt const wchar_t*, __in_z_opt const wchar_t*, unsigned int, uintptr_t);
...
{
    if (_ExpressionError == 0 || (_ExpressionError != _ErrorValue1 &&
                                  _ExpressionError != _ErrorValue2)) {
