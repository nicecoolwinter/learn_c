...
_MRTIMP2_NCEEPURE int __CLRCALL_PURE_OR_CDECL _Stoflt(const char*, const char*,
        char**,
        long[], int);
_MRTIMP2_NCEEPURE int __CLRCALL_PURE_OR_CDECL _Stoxflt(const char*, const char*,
        char**,
        long[], int);
...
_MRTIMP2_NCEEPURE double __CLRCALL_PURE_OR_CDECL _Poly(double, const double*,
        int);
...
_MRTIMP2_NCEEPURE short __CLRCALL_PURE_OR_CDECL _LDunscale(short*,
        long double*);
_MRTIMP2_NCEEPURE long double __CLRCALL_PURE_OR_CDECL _LPoly(long double,
