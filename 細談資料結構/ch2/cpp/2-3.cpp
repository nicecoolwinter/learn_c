...
void ArrMul(int [][MAX_SIZE], int [][MAX_SIZE], int [][MAX_SIZE], int, int,
            int);
...
void ArrAdd(int A[][MAX_SIZE], int B[][MAX_SIZE], int C[][MAX_SIZE], int rows,
            int cols)
{
    int i, j;
...
void ArrMul(int A[][MAX_SIZE], int B[][MAX_SIZE], int C[][MAX_SIZE], int m,
            int n, int t)
{
    int i, j, k ;
